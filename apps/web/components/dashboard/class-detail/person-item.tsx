...
export default function PersonItem({ name, avatarUrl, showRemove, onRemove }: PersonItemProps) {
  return (
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                size="icon"
                className="h-8 w-8 hover:text-foreground hover:bg-muted rounded-full cursor-pointer"
              >
